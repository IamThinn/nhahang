        ...
        <div class="row" style="flex-wrap: nowrap;">
            <div class="col-md-6 home-left-section">
                <div style="padding: 100px 0px; color: white;">
                    ...
                    <h2 style="color: #aa7700 !important; ">
                        EATS, DRINKS, FEELS.
                    </h2>
                    <hr>
                    <p style="color: black;">
                        Loving the food you like makes you feel better
                    </p>
...
<section class="our_qualities" style="padding:100px 0px; color: yellow;">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="our_qualities_column">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            Nguyên liệu, lương thực bảo đảm chất lượng, tươi tốt bảo quản nơi có nhiệt độ trung bình, tránh ánh nắng trực tiếp mặt trời
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="our_qualities_column">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            Giao hàng nhanh chóng, phục vụ chuyên nghiệp, tận tình. Đồ ăn trao tận tay, bảo đảm sự ngon miệng và chất lượng của món ăn như phục vụ trực tiếp trong nhà hàng.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="our_qualities_column">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            Món ăn có sự kết hợp hoà quyện từ các hương liệu, hương vị của Châu Á, Châu Âu mang đến trải nghiệm mới lạ cho thực khách thưởng thức, tận hưởng.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="footer_widget">
                    ...
                    <ul class="widget_social">
                        ...
                        <li><a href="#" data-toggle="tooltip" title="Google+"><i class="fab fa-google-plus-g fa-2x"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="footer_widget">
                    ...
                    <p>
<!--                        --><?php //echo $restaurant_address; ?>
                        Địa chỉ số 1597 - Trần Nguyên Hãn - Hải Phòng
                    </p>
                    <p>
<!--                        --><?php //echo $restaurant_email; ?>
                        <br>
