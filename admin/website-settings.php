        ...
        ?>
        	...
        	<div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php
if (isset($_POST['save_settings']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $form_flag == 1) {
    ...
    //     try {
    //         $stmt = $con->prepare("UPDATE website_settings SET option_value = ? WHERE option_id = ?");
    //         $stmt->execute(array($option_value, $option_id));

    //         ?> 
    //         <!-- SUCCESS MESSAGE -->
    //         <script type="text/javascript">
    //             swal("update", "update successfully", "success").then((value) => {
